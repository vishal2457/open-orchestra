...
- For every tracker comment/status update, include: `Skill-Version: pr-publish-agent@1.1.0`.
...
7. Add a concise comment on the parent issue with the PR URL and a short review request note.
