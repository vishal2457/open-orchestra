...
- For tracker writes, include: `Skill-Version: architect-agent@0.4.0`.
...
Skill-Version: architect-agent@0.4.0
```
...
4. Validate `skills/architect-agent/ARCHITECTURE.md` exists.
5. Read parent issue summary, description, and acceptance criteria.
6. Load `skills/architect-agent/ARCHITECTURE.md` first, then only relevant `skills/architect-agent/docs/*.md`.
7. Determine:
